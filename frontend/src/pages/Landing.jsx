    ...
    <div className="min-h-screen bg-bg-primary text-text-primary selection:bg-zync-purple/30 font-sans relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 md:px-6 pt-10 md:pt-16 pb-20 md:pb-32 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-4 md:mb-6 tracking-tight break-words">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mt-16 md:mt-32">

          {/* Feature 1 */}
          <div className="bg-[#141A2B]/70 border border-zync-blue/50 p-6 md:p-8 rounded-xl hover:border-zync-blue/80 transition-colors flex flex-col items-center text-center shadow-lg">
            <div className="w-12 h-12 flex items-center justify-center border border-border-subtle bg-[#080B14] rounded-lg mb-4 md:mb-6 text-zync-blue font-bold text-lg">
              01
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mb-2 md:mb-3">PLAY YOUR GAMES</h3>
          ...
          {/* Feature 2 */}
          <div className="bg-[#141A2B]/70 border border-zync-purple/50 p-6 md:p-8 rounded-xl hover:border-zync-purple/80 transition-colors flex flex-col items-center text-center shadow-lg">
            <div className="w-12 h-12 flex items-center justify-center border border-border-subtle bg-[#080B14] rounded-lg mb-4 md:mb-6 text-zync-purple font-bold text-lg">
              02
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mb-2 md:mb-3">MATCH SMARTER</h3>
            <p className="text-text-secondary text-sm leading-relaxed">
          ...
          {/* Feature 3 */}
          <div className="bg-[#141A2B]/70 border border-zync-cyan/50 p-6 md:p-8 rounded-xl hover:border-zync-cyan/80 transition-colors flex flex-col items-center text-center shadow-lg">
            <div className="w-12 h-12 flex items-center justify-center border border-border-subtle bg-[#080B14] rounded-lg mb-4 md:mb-6 text-zync-cyan font-bold text-lg">
              03
            </div>
            <h3 className="text-base md:text-lg font-bold text-white mb-2 md:mb-3">BUILD YOUR SQUAD</h3>
            <p className="text-text-secondary text-sm leading-relaxed">
